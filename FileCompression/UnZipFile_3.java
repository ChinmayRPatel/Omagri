...
public class UnZipFile_3 {
    ...
    public static void unzip(String zipFilePath, String destDirectory) throws IOException {
        ...
        try{
            ...
            while (entry != null) {
                ...
                System.out.println("File Path :- "+ filePath + " is directory = "+ entry.isDirectory() );
    ...
    public static void main(String[] args) {
        String zipFilePath = "C:\\Users\\Admin\\OneDrive\\Desktop\\Omagri\\myFolder.zip"; // Replace with the path to your ZIP file
        String destDirectory = "C:\\Users\\Admin\\OneDrive\\Desktop\\Omagri\\abcdefg\\xyz\\pqr\\"; // Replace with where you want to extract the files
